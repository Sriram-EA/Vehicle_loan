...
@Component({
  selector: 'app-four-wheeler-eligibility-checker',
  templateUrl: './four-wheeler-eligibility-checker.component.html',
  styleUrls: ['./four-wheeler-eligibility-checker.component.css']
})
export class FourWheelerEligibilityCheckerComponent implements OnInit {

  vehicleEligibility!:EligibilityChecker;
  fourWheelerVehicleList:Vehicle[]=[];
  vehicleType!:String;
...
public loadVehicleList()
{
  ...
  this.vehicleService.getFourWheelerVehicleList()
  .subscribe(response=>{this.fourWheelerVehicleList=response;

  this.vehicleType=this.fourWheelerVehicleList[0].vehicleType;});
